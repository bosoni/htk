    ...
    public static class ImageGDI
    {
        ...
        public static void LoadFromDisk(string filename, out uint texturehandle, out TextureTarget dimension)
        {
            ...
            try
            {
                ...
                if (GameLoop.Extensions.Contains("texture_non_power_of_two") == false) // jos npot textureita ei tueta
                {
                ...
                {
                    if (GameLoop.Extensions.Contains("EXT_framebuffer_object")) GL.Ext.GenerateMipmap(GenerateMipmapTarget.Texture2D);
                }
